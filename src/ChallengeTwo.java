public class ChallengeTwo {
    public static double stringToDouble(String number) {
        ...
        */
        ...
        double theDouble = Double.parseDouble(number); // ritorna il valore di tipo double attraverso la funzione .parseDouble permettte la conversione da String a double


        return theDouble; // ritorna il valore theDouble
